...
[![GitHub release (latest SemVer)](https://img.shields.io/github/v/release/CareDailyAI/python-core?sort=semver)](https://github.com/CareDailyAI/python-core/tree/latest)
...
<picture width="500">
  <source
    ...
    src="img/caredaily-logo-horiz-dark.svg"
    alt="CareDaily logo (dark)"
  />
  <img
    width="600"
    src="img/caredaily-logo-horiz.svg"
    alt="CareDaily logo (light)"
  />
</picture>
...
```bash
git clone https://github.com/CareDailyAI/python-core.git
cd python-core
pip install -e ".[dev]"
```
...
- Help find and fix issues by [**reporting bugs**](https://github.com/CareDailyAI/python-core/issues/new?labels=bug&template=bug-report---.md).
- Have a new idea?  Have a suggestion? [**Request a feature**](https://github.com/CareDailyAI/python-core/issues/new?labels=enhancement&template=feature-request---.md) to get our attention.

## Contributor Guide

Interested in contributing? Check out our
[CONTRIBUTING.md](https://github.com/CareDailyAI/python-core/blob/master/CONTRIBUTING.md)
