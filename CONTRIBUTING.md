...
CareDaily could always use better documentation,
whether as part of the official CareDaily docs,
...
CareDaily uses [Doxygen](https://www.doxygen.nl) to generate a static html page in the
