...
class TestAuthentication(unittest.TestCase):
    ...
    def test_send_passcode(self):
        ...
        self.mock_adapter.get.assert_called_once()
        args, kwargs = self.mock_adapter.get.call_args
        self.assertEqual(args[0], '/espapi/cloud/json/passcode')
    ...
    def test_login_by_key(self):
        ...
        self.mock_adapter.get.assert_called_once()
        args, kwargs = self.mock_adapter.get.call_args
        self.assertEqual(args[0], '/espapi/cloud/json/loginByKey')
    ...
    def test_logout(self):
        ...
        self.mock_adapter.get.assert_called_once()
        args, kwargs = self.mock_adapter.get.call_args
        self.assertEqual(args[0], '/espapi/cloud/json/logout')
    ...
    def test_create_totp_factor(self):
        ...
        self.assertEqual(args[0], '/espapi/cloud/json/totp')
    ...
    def test_get_operation_token(self):
        ...
        self.mock_adapter.get.assert_called_once()
        args, kwargs = self.mock_adapter.get.call_args
        self.assertEqual(args[0], '/espapi/cloud/json/token')
